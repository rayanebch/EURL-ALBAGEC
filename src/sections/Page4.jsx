...
const Page4 = () => {
  return (
    <div id='contact' className='page bg-contact bg-cover min-h-screen flex items-center justify-center p-4 pt-24'>
      <div className='bg-bluebg bg-opacity-40 p-10 px-20 shadow-lg flex flex-col justify-center items-center gap-10 mt-10 max-w-4xl max-sm:pt-20 max-sm:px-5 max-md:px-10 max-sm:gap-5'>
